        ...
        for assert_name in Test_Debug_Step().assert_data[0]:
            ...
            if result:
                ...
                try:
                    ...
                    Test_Debug_Step.assert_result.append({'code': '1', assert_name['name']: '断言成功'})
                except Exception as e:
                    print(e)
                    print(assert_name['name'], '断言失败')
                    Test_Debug_Step.assert_result.append({'code': '-1', assert_name['name']: '断言失败'})
            else:
                print('找不到该断言参数', assert_name['name'])
                Test_Debug_Step.assert_result.append({'code': '-1', assert_name['name']: '找不到该断言参数'})
